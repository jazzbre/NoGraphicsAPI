...
Command pools support independent recording, general/compute/copy queues, GPU timeline waits,
timestamps, task shaders, and suspended rendering. DX12 timestamps mark completion of preceding GPU work.
The backend currently binds one texture descriptor heap and one sampler descriptor heap per device.
